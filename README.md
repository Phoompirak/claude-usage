...
> ⚠️ **ต้องอ่านเลขสดจาก /usage ทุกครั้ง** อย่าใช้ตัวเลขตัวอย่างซ้ำ
> ถ้ายอดที่ใช้โตขึ้นแต่ % ที่ป้อนเท่าเดิม เพดานจะเฟ้อ แล้วเว็บจะแสดง % ต่ำกว่าความจริง
> ซึ่งอันตรายกว่าไม่ปรับเทียบเลย — เครื่องมือจะเตือนให้เมื่อจับสัญญาณนี้ได้
